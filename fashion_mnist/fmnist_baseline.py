...
# conv4
conv4 = Conv2D(64, kernel_size, strides=(1, 1), padding='valid', data_format='channels_first',
        dilation_rate=(1, 1), activation=None, use_bias=True, kernel_initializer='glorot_uniform',
        bias_initializer='zeros', kernel_regularizer=None, bias_regularizer=None, activity_regularizer=None,
...
bn4   = BatchNormalization(epsilon=epsilon, momentum=momentum, axis=1, name='bn4')(conv4)
act4  = Activation(relu6, name='act4')(bn4)

# conv5
conv5 = Conv2D(128, kernel_size, strides=(1, 1), padding='valid', data_format='channels_first',
        dilation_rate=(1, 1), activation=None, use_bias=True, kernel_initializer='glorot_uniform',
        bias_initializer='zeros', kernel_regularizer=None, bias_regularizer=None, activity_regularizer=None,
        kernel_constraint=None, bias_constraint=None, name='conv5')(act4)
#bpool2= MaxPooling2D(pool_size=pool_size, name='bpool2', data_format='channels_first')(conv5)
bn5   = BatchNormalization(epsilon=epsilon, momentum=momentum, axis=1, name='bn5')(conv5)
act5  = Activation(relu6, name='act5')(bn5)
...
merged2.compile(loss=keras.losses.categorical_crossentropy, optimizer=opt, metrics=['accuracy', top_3_accuracy])
...
##################################################################################################################################
# model visualization
plot_model(merged2, to_file='merged2.png', show_shapes=True, show_layer_names=True)
...
tbCallBack_f  = keras.callbacks.TensorBoard(log_dir='./Graph_f', histogram_freq=0, write_graph=True, write_images=True)
...
history1 = merged2.fit(X_train_f, Y_train_f,
                ...
                callbacks=[reduce_lr_f, csv_logger_f, tbCallBack_f])
##### End Batch Train #####
